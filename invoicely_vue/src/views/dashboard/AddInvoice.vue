    ...
    <div class="page-add-invoice">
        <nav class="breadcrumb" aria-label="breadcrumbs">
            <ul>
                ...
                <li class="is-active"><router-link :to="{ name: 'AddInvoice' }" aria-current="true">Add invoice</router-link></li>
            </ul>
        </nav>
        <div class="columns is-multiline">
            ...
            <div class="column is-12">
                <div class="box mt-4" v-if="invoice.client">
                    <h2 class="is-size-5 mb-5">Items</h2>
                    ...
                    <button class="button is-primary is-outlined" @click="addItem">+</button>
                </div>
            </div>
