    ...
    <div class="page-edit-team">
        <nav class="breadcrumb" aria-label="breadcrumbs">
            <ul>
                ...
                <li><router-link :to="{ name: 'MyAccount' }">MyAccount</router-link></li>
                <li class="is-active"><router-link :to="{ name: 'EditTeam' }" aria-current="true">Edit team</router-link></li>
            </ul>
        </nav>
        <div class="columns is-multiline">
            ...
            <div class="column is-12">
                ...
                <div class="field">
                    <div class="control">
                        <button @click="submitForm" class="button is-success">Save</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            getOrCreateTeam() {
                axios
                    ...
                    .then(response => {
                        ...
                        console.log(JSON.stringify(this.team.id))
                    })
                    .catch(error => {
